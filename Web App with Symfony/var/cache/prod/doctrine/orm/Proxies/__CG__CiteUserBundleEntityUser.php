...
class User extends \Cite\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Cite\\UserBundle\\Entity\\User' . "\0" . 'nbrMessages', '' . "\0" . 'Cite\\UserBundle\\Entity\\User' . "\0" . 'nbrLikes', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
