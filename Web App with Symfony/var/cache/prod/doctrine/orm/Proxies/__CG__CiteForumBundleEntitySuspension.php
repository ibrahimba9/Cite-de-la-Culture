 ...
 */
class Suspension extends \Cite\ForumBundle\Entity\Suspension implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cite\\ForumBundle\\Entity\\Suspension' . "\0" . 'id', '' . "\0" . 'Cite\\ForumBundle\\Entity\\Suspension' . "\0" . 'idSujet', '' . "\0" . 'Cite\\ForumBundle\\Entity\\Suspension' . "\0" . 'dateSuspension', '' . "\0" . 'Cite\\ForumBundle\\Entity\\Suspension' . "\0" . 'periode', '' . "\0" . 'Cite\\ForumBundle\\Entity\\Suspension' . "\0" . 'idAbonne'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Suspension $proxy) {
    ...
    public function setDateSuspension($dateSuspension)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateSuspension', [$dateSuspension]);

        return parent::setDateSuspension($dateSuspension);
    }
    ...
    public function getDateSuspension()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateSuspension', []);

        return parent::getDateSuspension();
    }
