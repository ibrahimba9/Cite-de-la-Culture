...
class __TwigTemplate_b5894cca804460425b340ab77162f9ae17511bb667455faa314ef0e22d98b784 extends Twig_Template
{
    ...
    <div align=\"center\">
        ...
        if ($this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_USER")) {
            ...
            if (($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", []) != $this->getAttribute((isset($context["sujet"]) ? $context["sujet"] : $this->getContext($context, "sujet")), "idAbonne", []))) {
                ...
                echo "\" href=\"#\" onclick=\"showModal()\">Signaler</a>
            ";
            }
            // line 50
            echo "        ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
            ...
            if ($this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_USER")) {
                ...
                if (($this->getAttribute($context["msg"], "idAbonne", []) != $this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", []))) {
                    ...
                    echo "\" href=\"#\" onclick=\"showModalComment()\">Signaler</a></td>
                                                ";
                }
                // line 102
                echo "                                                ";
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", []), "id", []) == $this->getAttribute($this->getAttribute($context["msg"], "idAbonne", []), "id", []))) {
                    ...
                    echo "\" href=\"#\" onclick=\"showModalDelete()\">Supprimer</a></td>
                                                ";
                }
                // line 105
                echo "                                            </tr>
...
";
    ...
    {
        return array (  345 => 137,  341 => 135,  335 => 132,  331 => 131,  325 => 128,  321 => 127,  314 => 123,  310 => 122,  307 => 121,  305 => 120,  299 => 117,  296 => 116,  283 => 108,  278 => 105,  272 => 103,  269 => 102,  263 => 100,  261 => 99,  258 => 98,  250 => 96,  242 => 94,  240 => 93,  236 => 91,  228 => 89,  220 => 87,  218 => 86,  213 => 83,  211 => 82,  203 => 77,  196 => 73,  186 => 66,  180 => 63,  174 => 60,  168 => 56,  164 => 55,  158 => 51,  155 => 50,  150 => 48,  143 => 47,  140 => 46,  138 => 45,  132 => 44,  96 => 10,  87 => 9,  75 => 6,  70 => 5,  61 => 4,  42 => 2,  11 => 1,);
    }
    ...
    <div align=\"center\">
        ...
        {% if is_granted('ROLE_USER') %}
            {% if app.user != sujet.idAbonne %}
                ...
                <a id=\"myBtn\" data-href=\"{{ path('signaler_sujet', {'id' : sujet.idSujet}) }}\" href=\"#\" onclick=\"showModal()\">Signaler</a>
            {% endif %}
        {% endif %}
    </div>
        <br/>
                                        ...
                                        <table style=\"background-color: transparent\" border=\"0px\">
                                            <tr style=\"background-color: transparent\">
                                                ...
                                                {% if msg.idAbonne != app.user %}
                                                    <td><a id=\"linkSignComm\" data-href=\"{{ path('signal_message', {'id' : msg.idMessage}) }}\" href=\"#\" onclick=\"showModalComment()\">Signaler</a></td>
                                                {% endif %}
                                                {% if app.user.id == msg.idAbonne.id %}
                                                    <td><a id=\"linkDelete\" data-href=\"{{ path('supprimer_message', { 'id' : msg.idMessage }) }}\" href=\"#\" onclick=\"showModalDelete()\">Supprimer</a></td>
                                                {% endif %}
                                            </tr>
                                        </table>
                                    {% endif %}
