...
class __TwigTemplate_79bae0ee770ceab694ee1aac2b04df75dfbb879738c4d78716729bc2a7043989 extends Twig_Template
{
    ...
    <script>
        ...
        channel.bind(\"my-event\", function(data) {
            ...
            data.forEach(function(item){
                let li = '<div style=\"list-style-position:inside; border: 1px solid black;width: 400px; background-color: #24C2C7;\"><li><a onclick=\"decrement()\" class=\"linkUnseen\" href=\"ConsulterNotificationNumber/'+item.number+'\"><u>'+ item.title +'</u></a>  </li> <li><a>'+ item.description +'</a></li></div>';
