...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7gFMkKpcsN', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aqUmcy6ovM', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, ['debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => [0 => 'form_div_layout.html.twig'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'paths' => [], 'date' => ['format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL], 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-7lpa2PWqx', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AGsGAwyQTW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TwMkfuGYjm', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Cite\\UserBundle/Resources/views'), 'CiteUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Cite\\UserBundle/Resources/views'), '!CiteUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Cite\\ForumBundle/Resources/views'), 'CiteForum');
        $instance->addPath(($this->targetDirs[3].'\\src\\Cite\\ForumBundle/Resources/views'), '!CiteForum');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'CiteUserBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Cite\\UserBundle'),
                    'namespace' => 'Cite\\UserBundle',
                ],
                'CiteForumBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Cite\\ForumBundle'),
                    'namespace' => 'Cite\\ForumBundle',
                ],
                'KnpPaginatorBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'CiteUserBundle' => 'Cite\\UserBundle\\CiteUserBundle',
                'CiteForumBundle' => 'Cite\\ForumBundle\\CiteForumBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'your_email',
            ...
            'fos_user.model.user.class' => 'Cite\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'email' => 'Contact Cité de la Culture',
            ],
            ...
            'notifications' => [
                'app_id' => 761982,
                'app_key' => '4156c672a90088a79010',
                'app_secret' => '7b46c4cb9cf9f48043a9',
                'cluster' => 'eu',
                'encrypted' => false,
            ],
