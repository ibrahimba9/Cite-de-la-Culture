...
namespace Proxies\__CG__\Cite\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Cite\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Cite\\UserBundle\\Entity\\User' . "\0" . 'nbrMessages', '' . "\0" . 'Cite\\UserBundle\\Entity\\User' . "\0" . 'nbrLikes', '' . "\0" . 'Cite\\UserBundle\\Entity\\User' . "\0" . 'isBanned', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setNbrLikes($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbrLikes', [$value]);

        return parent::setNbrLikes($value);
    }
    ...
    public function setIsBanned($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsBanned', [$value]);

        return parent::setIsBanned($value);
    }
