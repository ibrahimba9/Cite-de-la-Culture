...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\Cite\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Cite\\ForumBundle\\Entity')]);

$b->addDriver($c, 'Cite\\UserBundle\\Entity');
$b->addDriver($c, 'Cite\\ForumBundle\\Entity');
...
$a->setEntityNamespaces(['CiteUserBundle' => 'Cite\\UserBundle\\Entity', 'CiteForumBundle' => 'Cite\\ForumBundle\\Entity']);
